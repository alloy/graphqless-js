    ...
    g.visitWithTypeInfo(typeInfo, {
      ...
      Field: {
        ...
        leave(fieldNode) {
          ...
          if (g.isScalarType(type)) {
            const [resolverExpression, hasAsyncResolver] = compileScalarTypeResolver({ typeInfo, fieldNode, argumentProperties, source, emitAST })
            ...
            expression = compileObjectTypeResolver({ typeInfo, fieldNode, argumentProperties, source, parentSource, selectionSet, markAsync })
          }
